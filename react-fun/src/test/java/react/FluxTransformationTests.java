...
public class FluxTransformationTests {
	...
	@Test
	public void takeBasedOnTime() {
		Flux<String> nationalPark = Flux.just("Yellowstone", "Yosemite", "Grand Canyon", "Zion", "Grand Teton")
				.delayElements(Duration.ofSeconds(1)).take(Duration.ofMillis(3500));
		StepVerifier.create(nationalPark).expectNext("Yellowstone", "Yosemite", "Grand Canyon").verifyComplete();
	}
